...
export default function Replies({ toggle }) {
  ...
  return (
    <div className="my-5">
      <div className="flex items-start gap-3">
        <div>
          <img src="https://source.unsplash.com/iEEBWgY_6lA" className="w-12 h-12 rounded-full" alt="d" />
        </div>
          ...
          <div className="bg-gray-100 rounded-lg mt-[3px] pt-2 px-3 pb-3">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <Link to="/users" className="flex items-center gap-1 mb-2 ">
                <h2 className="font-semibold text-sm hover:underline">Nazmul Islam</h2>
            ...
            <p className="text-sm mt-1">
              This is comment Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus, id!
            </p>
          </div>
          <div className="text-xs flex items-center gap-3 mt-2 font-semibold text-gray-600">
            <button type="button" className="hover:bg-gray-100 rounded-sm px-1 py-[.5px]">
              like
            </button>
            <button
              type="button"
