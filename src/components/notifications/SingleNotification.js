                ...
                <div className="text-black text-lg flex items-center gap-2">
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-[13px] text-g text-opacity-70 font-medium">
                                138 reactions · 20 comments
                            </p>
                            ...
                            <div>
                                <h2 className="text-[17px] leading-[20px]">
                                    ...
                                    <span className="font-medium">
                                        What science tell us about the world creation.
                                    </span>
                                </h2>
                                <p className="text-[13px] text-g text-opacity-70 font-medium">
                                    138 reactions · 20 comments
                                </p>
                                <p className="text-[13px] text-g text-opacity-70 font-medium -mt-[8px]">
                                    20m ago
                                </p>
                            </div>
            ...
            <div className="rounded-sm hover:bg-gray-50 pb-2 group pt-4 px-2 border-b">
                <div className="text-black text-lg flex items-center gap-2">
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            <h2 className="text-[17px] leading-[20px]">
                                <span className="font-medium">Jahid hasan</span> commented on your
                                post <span className="font-medium">Beautify world</span>
                            </h2>
                            <p className="text-[13px] text-g text-opacity-70 font-medium">
                                138 reactions · 20 comments
                            </p>
